export const skillsData = [
  // Frontend: common web technologies
  { name: "HTML/CSS", category: "frontend" },
  { name: "Javascript", category: "frontend" },
  { name: "React", category: "frontend" },

  // Backend: languages and frameworks for the server-side
  ...
  // Frameworks: libraries or toolkits often used for data or ML
